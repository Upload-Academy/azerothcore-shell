...
def generate_dungeon_vendor_groups(data, fd):
    for i, group in enumerate(data['dungeon_vendor_groups']):
        ...
        if group['weapon_vendor']:
            ...
            weaponVendorSpawn = f"INSERT INTO `creature` (`id1`,`map`,`position_x`,`position_y`,`position_z`,`orientation`) VALUES ({weaponVendorEntry},{group['map']},{group['weapon_vendor']['x']},{group['weapon_vendor']['y']},{group['weapon_vendor']['z']},{group['weapon_vendor']['o']});"
        ...
        if group['clothing_vendor']:
            ...
            clothingVendorSpawn = f"INSERT INTO `creature` (`id1`,`map`,`position_x`,`position_y`,`position_z`,`orientation`) VALUES ({clothingVendorEntry},{group['map']},{group['clothing_vendor']['x']},{group['clothing_vendor']['y']},{group['clothing_vendor']['z']},{group['clothing_vendor']['o']});"
        ...
        if group['other_vendor']:
            ...
            otherVendorSpawn = f"INSERT INTO `creature` (`id1`,`map`,`position_x`,`position_y`,`position_z`,`orientation`) VALUES ({otherVendorEntry},{group['map']},{group['other_vendor']['x']},{group['other_vendor']['y']},{group['other_vendor']['z']},{group['other_vendor']['o']});"
        ...
        if group['vendor_home']:
            if 'tent01' in group['vendor_home'] and group['vendor_home']['tent01']:
                ...
                tent01Delete = f"DELETE FROM `gameobject` WHERE (`id` = {entryId});"
            ...
            if 'tent02' in group['vendor_home'] and group['vendor_home']['tent02']:
                ...
                tent02Delete = f"DELETE FROM `gameobject` WHERE (`id` = {entryId});"
            ...
            if 'tent03' in group['vendor_home'] and group['vendor_home']['tent03']:
                ...
                tent03Delete = f"DELETE FROM `gameobject` WHERE (`id` = {entryId});"
            ...
            if 'boxes01' in group['vendor_home'] and group['vendor_home']['boxes01']:
                ...
                boxes01Delete = f"DELETE FROM `gameobject` WHERE (`id` = {entryId});"
            ...
            if 'boxes02' in group['vendor_home'] and group['vendor_home']['boxes02']:
                ...
                boxes02Delete = f"DELETE FROM `gameobject` WHERE (`id` = {entryId});"
            ...
            if 'boxes03' in group['vendor_home'] and group['vendor_home']['boxes03']:
                ...
                boxes03Delete = f"DELETE FROM `gameobject` WHERE (`id` = {entryId});"
